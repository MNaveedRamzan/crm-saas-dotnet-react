...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CrmSaas API", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "CRM SaaS API v1");
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        // 🔑 This creates database + tables if missing
